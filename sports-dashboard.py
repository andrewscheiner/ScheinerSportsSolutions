...
import tools.MLBMonthlyWins as mlb_monthlywins
...
if cols2[1].button("⚾ MLB Monthly Wins"):
    st.session_state.page = "mlb_monthlywins"
...
if st.session_state.page == "nba_daily":
    ...
    nrfi.app()
elif st.session_state.page == "mlb_monthlywins":
    mlb_monthlywins.app()
